...
class CartPage extends DefaultPage{
    ...
    @FindBy(xpath = "//*[@id=\"dnn_ctr36182979_ViewBasket_BasketDetails_gvBasketDetails\"]/table/tbody/tr[1]/td[4]/div/a[2]")
    private WebElement firstProductInstanceCount

    @FindBy(xpath = "//*[@id=\"dnn_ctr36182979_ViewBasket_BasketDetails_lbtnUpdateQtyAndVariants\"]")
    private  WebElement updateBagBtn

    @FindBy(xpath = "//*[@id=\"dnn_ctr36182979_ViewBasket_BasketDetails_gvBasketDetails\"]/table/tbody/tr[1]/td[6]/span[2]")
    private static WebElement firstCostHolder
    
    @FindBy(xpath = "//*[@id=\"dnn_ctr36182979_ViewBasket_BasketDetails_gvBasketDetails\"]/table/tbody/tr[2]/td[6]/span[2]")
